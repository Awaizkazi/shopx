...
class TeamReport2 extends StatefulWidget {
  const TeamReport2({super.key});

  @override
  State<TeamReport2> createState() => _TeamReport2State();
}

class _TeamReport2State extends State<TeamReport2> {
  final url =
